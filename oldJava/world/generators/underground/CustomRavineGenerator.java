...
public class CustomRavineGenerator extends MapGenBase
{
    ...
    protected void addTunnel(long p_180707_1_, int chunkX, int chunkZ, ChunkPrimer primer, double p_180707_6_, double p_180707_8_, double p_180707_10_, float p_180707_12_, float p_180707_13_, float p_180707_14_)
    {
        ...
        int p_180707_16_ = i - random.nextInt(i / 4);
    ...
    protected void recursiveGenerate(@Nonnull World worldIn, int chunkX, int chunkZ, int originalX, int originalZ, @Nonnull ChunkPrimer chunkPrimerIn)
    {
        if(this.rand.nextInt(50) == 0)
        {
            ...
            for(int j = 0; j < 1; ++j)
            {
                ...
                this.addTunnel(this.rand.nextLong(), originalX, originalZ, chunkPrimerIn, d0, d1, d2, f2, f, f1);
            }
        }
    }
