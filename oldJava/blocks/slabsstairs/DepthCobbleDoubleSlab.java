...
public class DepthCobbleDoubleSlab extends SlabBase
{
    public DepthCobbleDoubleSlab(String name, Material materialIn)
    {
    ...
    {
        return new ItemStack(ModBlocks.DEPTH_COBBLE_SLAB_HALF);
    }
