...
public class ContainerManaGeneratorInsanity extends Container
{
    ...
    public ContainerManaGeneratorInsanity(InventoryPlayer player, TileEntityManaGeneratorInsanity tileEntity)
    {
        te = tileEntity;
    ...
    public ItemStack transferStackInSlot(@Nonnull EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (TileEntityManaGeneratorInsanity.isItemFuel(itemstack1))
                {
