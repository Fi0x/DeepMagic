...
import com.fi0x.deepmagic.blocks.containers.ContainerManaFurnace;
...
public class GuiManaFurnace extends GuiContainer//TODO:Adjust class
{
    ...
    public GuiManaFurnace(InventoryPlayer player, TileEntityManaFurnace tileentity)
    {
        super(new ContainerManaFurnace(player, tileentity));
        this.player = player;
        te = tileentity;
    }
