...
public class LargeDungeonComponent extends StructureComponentTemplate
{
    ...
    public LargeDungeonComponent(TemplateManager templateManager, Template template, String templateName,
    ...
    public LargeDungeonComponent(TemplateManager templateManager, String templateName, boolean fillBelow,
