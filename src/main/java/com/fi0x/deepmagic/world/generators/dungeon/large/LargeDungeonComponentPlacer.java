...
public class LargeDungeonComponentPlacer
{
    ...
    public static void generate(World world, IChunkGenerator generator, TemplateManager templateManager, BlockPos position,
                                Rotation rot, Random random, List<LargeDungeonComponent> pieces) {
    ...
    public static void generateGenericPillar(World world, ITAChunkGenerator generator, TemplateManager templateManager, BlockPos.MutableBlockPos current, Rotation rot,
                                             Mirror mirror, Random random, List<LargeDungeonComponent> pieces, UUID ward) {
        ...
        pieces.add(new LargeDungeonComponent(templateManager, sTemplate, name, false,
        ...
        pieces.add(new LargeDungeonPillarComponent(templateManager, sTemplate, name, false,
                current.toImmutable(), rot, mirror, ward, PillarType.GENERIC));

        current.setPos(backup);
    }

    public static BlockPos generateBase(World world, ITAChunkGenerator generator, TemplateManager templateManager, BlockPos.MutableBlockPos current,
                                        Rotation rot, Mirror mirror, Random random, List<LargeDungeonComponent> pieces, UUID ward) {

        BlockPos original = current.toImmutable();
        LargeDungeonComponent base = new LargeDungeonBaseComponent(templateManager, pickTemplate(BASE, random),
        ...
        for (EnumFacing f : EnumFacing.HORIZONTALS) {
            ...
            current.setPos(current.getX() + add.getX(), current.getY(), current.getZ() + add.getZ());
            pieces.add(new LargeDungeonBaseComponent(templateManager, template, tName, true,
    ...
    public static void generateGroundFloor(World world, ITAChunkGenerator generator, TemplateManager templateManager, BlockPos.MutableBlockPos current, BlockPos baseSize,
                                           Rotation rot, Mirror mirror, Random random, List<LargeDungeonComponent> pieces, UUID ward) {
        ...
        current.setPos(current.getX() + add.getX(), current.getY(), current.getZ() + add.getZ());
        LargeDungeonComponent floor = new LargeDungeonComponent(templateManager, template, tName,
    ...
    public static void generateFirstFloor(World world, ITAChunkGenerator generator, TemplateManager templateManager, BlockPos.MutableBlockPos current, BlockPos baseSize,
                                          Rotation rot, Mirror mirror, Random random, List<LargeDungeonComponent> pieces, UUID ward) {
        ...
        pieces.add(new LargeDungeonComponent(templateManager, cTemplate, cName, false,
    ...
    public static void generateMazePillar(World world, ITAChunkGenerator generator, TemplateManager templateManager, BlockPos.MutableBlockPos current, Rotation rot,
                                          Mirror mirror, Random random, List<LargeDungeonComponent> pieces, UUID ward) {
    ...
    public static void generateMaze(World world, ITAChunkGenerator generator, TemplateManager templateManager, BlockPos.MutableBlockPos current, BlockPos baseSize,
                                    Rotation rot, Mirror mirror, Random random, List<LargeDungeonComponent> pieces, UUID ward) {
        ...
        pieces.add(new LargeDungeonComponent(templateManager, sTemplate, shellName, false,
                current.toImmutable(), rot, mirror, ward));
        ...
        for (int z = 0; z < maze.getLength(); ++z) {
            for (int x = 0; x < maze.getWidth(); ++x) {
                ...
                pieces.add(new LargeDungeonMazeComponent(templateManager, templateManager.get(FMLCommonHandler.instance().getMinecraftServerInstance(),
    ...
    public static void generateSecondFloor(World world, ITAChunkGenerator generator, TemplateManager templateManager, BlockPos.MutableBlockPos current, BlockPos baseSize,
                                           Rotation rot, Mirror mirror, Random random, List<LargeDungeonComponent> pieces, UUID ward) {
    ...
    public static void generatePrison(World world, ITAChunkGenerator generator, TemplateManager templateManager, BlockPos.MutableBlockPos current, BlockPos baseSize,
                                      Rotation rot, Mirror mirror, Random random, List<LargeDungeonComponent> pieces, UUID ward) {
        ...
        pieces.add(new LargeDungeonComponent(templateManager, template, piece, false,
                current.toImmutable(), rot, mirror, ward));
        ...
        current.setPos(current.getX() + add.getX(), current.getY(), current.getZ() + add.getZ());
        pieces.add(new LargeDungeonComponent(templateManager, edge1, piece, false,
        ...
        current.setPos(current.getX() + add.getX(), current.getY(), current.getZ() + add.getZ());
        pieces.add(new LargeDungeonComponent(templateManager, edge2, piece, false,
                current.toImmutable(), rot, mirror, ward));
    ...
    public static void generatePrisonBlock0(World world, ITAChunkGenerator generator, TemplateManager templateManager, BlockPos.MutableBlockPos current, BlockPos edgeSize1,
                                            BlockPos edgeSize2, BlockPos baseSize, Rotation rot, Mirror mirror, Random random,
                                            List<LargeDungeonComponent> pieces, UUID ward) {
        ...
        pieces.add(new LargeDungeonComponent(templateManager, corner1, piece, false,
        ...
        current.setPos(current.getX() + add.getX(), current.getY() - 1, current.getZ() + add.getZ());
        pieces.add(new LargeDungeonComponent(templateManager, corner2, piece, false, current.toImmutable(),
        ...
        current.setPos(current.getX() + add.getX(), current.getY(), current.getZ() + add.getZ());
        pieces.add(new LargeDungeonComponent(templateManager, side1, piece, false, current.toImmutable(),
        ...
        current.setPos(current.getX() + add.getX(), current.getY(), current.getZ() + add.getZ());
        pieces.add(new LargeDungeonComponent(templateManager, side2, piece, false, current.toImmutable(),
                mirror == Mirror.NONE ? rot.add(Rotation.COUNTERCLOCKWISE_90) : rot.add(Rotation.CLOCKWISE_90), mirror, ward));
        ...
        current.setPos(current.getX() + add.getX(), current.getY() - 1, current.getZ() + add.getZ());
        pieces.add(new LargeDungeonComponent(templateManager, corner3, piece, false, current.toImmutable(),
                mirror == Mirror.NONE ? rot.add(Rotation.CLOCKWISE_90) : rot.add(Rotation.COUNTERCLOCKWISE_90), mirror, ward));
        ...
        current.setPos(current.getX() + add.getX(), current.getY() - 1, current.getZ() + add.getZ());
        pieces.add(new LargeDungeonComponent(templateManager, corner4, piece, false,
                current.toImmutable(), rot, mirror, ward));
    ...
    public static void generatePrisonBlock1(World world, ITAChunkGenerator generator, TemplateManager templateManager, BlockPos.MutableBlockPos current, BlockPos baseSize,
                                            Rotation rot, Mirror mirror, Random random, List<LargeDungeonComponent> pieces, UUID ward) {
        ...
        add = transformOffset(-side3.getSize().getX() / 2,
                -corner4.getSize().getZ() - side2.getSize().getX() - corner2.getSize().getZ() / 2, rot, mirror);
        current.setPos(current.getX() + add.getX(), current.getY(), current.getZ() + add.getZ());
        pieces.add(new LargeDungeonComponent(templateManager, side3, piece, false,
                current.toImmutable(), rot, mirror, ward));
    ...
    public static void generateThirdFloor(World world, ITAChunkGenerator generator, TemplateManager templateManager, BlockPos.MutableBlockPos current, BlockPos baseSize,
                                          Rotation rot, Mirror mirror, Random random, List<LargeDungeonComponent> pieces, UUID ward) {
    ...
    public static void generateLibraryPillar(World world, ITAChunkGenerator generator, TemplateManager templateManager, BlockPos.MutableBlockPos current, Rotation rot,
                                             Mirror mirror, Random random, List<LargeDungeonComponent> pieces, UUID ward) {
    ...
    public static void generateLibrary(World world, ITAChunkGenerator generator, TemplateManager templateManager, BlockPos.MutableBlockPos current, BlockPos connectorSize,
                                       Rotation rot, Mirror mirror, Random random, List<LargeDungeonComponent> pieces, UUID ward) {
        ...
        current.setPos(current.getX() + add.getX(), current.getY() - 3, current.getZ() + add.getZ());
        pieces.add(new LargeDungeonComponent(templateManager, template, tName, false,
                current.toImmutable(), rot, mirror, ward));
        BlockPos.MutableBlockPos mainSize = new BlockPos.MutableBlockPos(template.getSize());
        ...
        current.setPos(current.getX() + add.getX(), current.getY() + mainSize.getY() + template.getSize().getY() - 2, current.getZ() + add.getZ());
        pieces.add(new LargeDungeonComponent(templateManager, template, tName, false, current.toImmutable(),
                mirror == Mirror.NONE ? rot.add(Rotation.COUNTERCLOCKWISE_90) : rot.add(Rotation.CLOCKWISE_90), mirror, ward));
    ...
    public static void generateFourthFloor(World world, ITAChunkGenerator generator, TemplateManager templateManager, BlockPos.MutableBlockPos current, BlockPos baseSize,
                                           Rotation rot, Mirror mirror, Random random, List<LargeDungeonComponent> pieces, UUID ward) {
    ...
    public static void generateBossRoom(World world, ITAChunkGenerator generator, TemplateManager templateManager, BlockPos.MutableBlockPos current, BlockPos baseSize,
                                        Rotation rot, Mirror mirror, Random random, List<LargeDungeonComponent> pieces, UUID ward) {
        ...
        current.setPos(current.getX() + add.getX(), current.getY() - 2, current.getZ() + add.getZ());
        pieces.add(new LargeDungeonComponent(templateManager, bTemplate, bossName, false,
                current.toImmutable(), rot, mirror, ward));
