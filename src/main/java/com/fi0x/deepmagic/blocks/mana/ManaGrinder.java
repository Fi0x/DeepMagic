...
public class ManaGrinder extends BlockBase implements ITileEntityProvider//TODO: Adjust class
{
    public static final PropertyDirection FACING = BlockHorizontal.FACING;
    public static final PropertyBool RUNNING = PropertyBool.create("running");

    public ManaGrinder(String name, Material material)
    {
        super(name, material);
    ...
    {
        return Item.getItemFromBlock(ModBlocks.MANA_GRINDER);
    }
    @Override
    ...
    {
        return new ItemStack(ModBlocks.MANA_GRINDER);
    }
    @Override
    ...
    public static void setState(boolean active, World world, BlockPos pos)
    {
        ...
        if(active) world.setBlockState(pos, ModBlocks.MANA_GRINDER.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(RUNNING, true), 3);
        else world.setBlockState(pos, ModBlocks.MANA_GRINDER.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(RUNNING, false), 3);
