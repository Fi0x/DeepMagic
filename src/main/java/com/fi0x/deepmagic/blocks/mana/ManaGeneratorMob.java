...
public class ManaGeneratorMob extends BlockBase implements ITileEntityProvider
{
    ...
    public ManaGeneratorMob(String name, Material material)
    {
        super(name, material);
    ...
    public boolean onBlockActivated(World worldIn, @Nonnull BlockPos pos, @Nonnull IBlockState state, @Nonnull EntityPlayer playerIn, @Nonnull EnumHand hand, @Nonnull EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        if(!worldIn.isRemote)
        {
            ...
            else playerIn.openGui(Main.instance, ConfigHandler.guiManaGeneratorMobID, worldIn, pos.getX(), pos.getY(), pos.getZ());
        }
        return true;
    }
    ...
    {
        return new ItemStack(ModBlocks.MANA_GENERATOR_MOB);
    }
    @Override
    ...
    {
        return new TileEntityManaGeneratorMob();
    }
    ...
    {
        if(rand.nextInt(100) + 1 > ConfigHandler.manaGeneratorParticles) return;
    ...
    public static void setState(boolean active, World world, BlockPos pos)
    {
        ...
        if(active) world.setBlockState(pos, ModBlocks.MANA_GENERATOR_MOB.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(RUNNING, true), 3);
        else world.setBlockState(pos, ModBlocks.MANA_GENERATOR_MOB.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(RUNNING, false), 3);
