...
public class newManaAltar extends BlockBase implements ITileEntityProvider
{
    public static final PropertyDirection FACING = BlockHorizontal.FACING;

    public newManaAltar(String name, Material material)
    {
        super(name, material);
    ...
    {
        newTileEntityManaAltar te = (newTileEntityManaAltar) worldIn.getTileEntity(pos);
        assert te != null;
    ...
    {
        return new newTileEntityManaAltar();
    }
