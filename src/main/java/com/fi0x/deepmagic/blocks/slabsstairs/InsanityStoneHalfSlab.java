...
public class InsanityStoneHalfSlab extends SlabBase implements IHasModel
{
    public InsanityStoneHalfSlab(String name, Material materialIn, BlockSlab doubleSlab)
    {
