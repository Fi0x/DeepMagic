...
public class InsanityWoodDoubleSlab extends SlabBase
{
    public InsanityWoodDoubleSlab(String name, Material materialIn)
    {
    ...
    {
        return new ItemStack(ModBlocks.INSANITY_WOOD_SLAB_HALF);
    }
