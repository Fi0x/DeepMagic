...
public class DepthLeaves extends BlockLeaves implements IHasModel
{
    public DepthLeaves(String name)
    {
        super();
    ...
    {
        if(worldIn.rand.nextInt(chance) <= 2)
        {
            spawnAsEntity(worldIn, pos, new ItemStack(ModItems.DEPTH_APPLE));
        }
    }
    @Nonnull
    @Override
