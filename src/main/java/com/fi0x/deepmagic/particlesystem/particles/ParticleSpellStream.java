...
public class ParticleSpellStream extends Particle
{
    public ParticleSpellStream(String textureName, World worldIn, double x, double y, double z, double scale, double speedX, double speedY, double speedZ)
    {
